import React from "react"; //need {useState} if user auth is needed
import "./App.scss";
import "./index.css";
import Navigate from "./components/Navbar/navbar";
// import Auth from "./components/Auth/auth";  Auth is here in case user authentication is needed
...
function App() {
  // Use code below for user authentication, if needed. 
